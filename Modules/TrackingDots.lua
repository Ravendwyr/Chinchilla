...
--[[		preview = {
		...
		preview1 = {
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.461914, 0.493164, 0.931641, 0.994141 },
			order = 4,
		},
		preview2 = {
			-- ["PlayerFriend"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.495117, 0.526367, 0.201172, 0.263672 },
			order = 5,
		},
		preview3 = {
			-- ["PlayerNeutral"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.495117, 0.526367, 0.267578, 0.330078 },
			order = 6,
		},
		preview4 = {
			-- ["PlayerEnemy"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.495117, 0.526367, 0.134766, 0.197266 },
			order = 7,
		},
		preview5 = {
			-- ["MonsterFriend"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.461914, 0.493164, 0.599609, 0.662109 },
			order = 8,
		},
		preview6 = {
			-- ["MonsterNeutral"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.461914, 0.493164, 0.666016, 0.728516 },
			order = 9,
		},
		preview7 = {
			-- ["MonsterEnemy"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.461914, 0.493164, 0.533203, 0.595703 },
			order = 10,
		},
		preview8 = {
			-- ["Object"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.461914, 0.493164, 0.865234, 0.927734 },
			order = 11,
		},
		preview9 = {
			-- ["QuestNormal"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.661133, 0.692383, 0.00195312, 0.0644531 },
			order = 12,
		},
		preview10 = {
			-- ["QuestTurnin"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.793945, 0.825195, 0.00195312, 0.0644531 },
			order = 13,
		},
		preview11 = {
			-- ["QuestDaily"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.561523, 0.592773, 0.00195312, 0.0644531 },
			order = 14,
		},
		preview12 = {
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.727539, 0.758789, 0.00195312, 0.0644531 },
			order = 15,
		},
		preview13 = {
			-- ["FlightPath"]
			...
			fontSize = "medium",
			image = image,
			imageCoords = { 0.395508, 0.426758, 0.865234, 0.927734 },
			order = 16,
		},
	}
end

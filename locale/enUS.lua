Rock("LibRockLocale-1.0"):GetTranslationNamespace("Chinchilla"):AddTranslations("enUS", function() return {
	...
	["Calendar"] = true,
	["Set the position of the calendar"] = true,
	["Tracking"] = true,
	...
	["Durability"] = true,
	["Quest tracker"] = true,
	["Quest and achievement tracker"] = true,
	["Quest timer"] = true,
	...
	["Position of the quest/achievement tracker on the screen"] = true,
	...
	["Position of the vehicle seat indicator on the screen"] = true,
	["Show a frame that is movable to show where you want the vehicle seat indicator to be"] = true,
	["Set the position on the x-axis for the vehicle seat indicator."] = true,
	["Set the position on the y-axis for the vehicle seat indicator."] = true,
